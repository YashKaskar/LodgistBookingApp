    ...
    <div > 
      <header className='bg-lodgist p-2 flex justify-between'>
          ...
          <div className='flex gap-5 text-sm md:text-lg items-center mr-4 md:mr-8 md:align-middle'>
            <div className='hover:text-gray-700 text-white'>Anywhere</div>
            <div className='hover:text-gray-700 text-white'>Any week</div>
            <div className='hover:text-gray-700 text-white'>Add guests</div>
          ...
          <div className='flex gap-2 py-0 px-1 mt-6 mb-7 md:mr-6 bg-lodgist1 text-fuchsia-700 hover:text-lodgist1 hover:bg-fuchsia-500 rounded-full'> 
